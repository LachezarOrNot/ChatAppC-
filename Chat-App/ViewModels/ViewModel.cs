...
namespace ChatApp.ViewModels
{
    ...
    Convert.ToDateTime(reader["MsgSentOn"].ToString()).ToString("MMM dd, hh:mm tt") : "";
        ...
        public static string pathLocal = Directory.GetParent((Directory.GetParent(Environment.CurrentDirectory.ToString()).ToString())).ToString();
     
        public   SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + pathLocal + "\\Database\\Database1.mdf;Integrated Security=True");
